...
export type PortfolioPhoto = {
  ...
  collection: "Stage" | "Campus" | "Occasions" | "Portraits";
...
export const stagePortfolio: readonly PortfolioPhoto[] = [
  { src: "/portfolio/01-live-in-red.webp", alt: "Arun Guinness singing into a microphone in a red shirt during a live stage show", caption: "A live vocal performance, close to the audience and fully in the moment.", category: "Live performance", collection: "Stage", orientation: "landscape", focalPoint: "50% 40%" },
  { src: "/portfolio/13-school-audience-show.webp", alt: "Arun Guinness singing among a large group of schoolchildren", caption: "Taking the song into the audience at a school celebration.", category: "Community event", collection: "Campus", orientation: "landscape", focalPoint: "55% 46%" },
  { src: "/portfolio/04-community-stage.webp", alt: "Collage of Arun Guinness performing with another singer and children on a community stage", caption: "Music, movement and audience participation across a community stage.", category: "Community event", collection: "Occasions", orientation: "portrait", focalPoint: "50% 45%" },
  { src: "/portfolio/12-onam-muscat-stage.webp", alt: "Arun Guinness performing at an Onam celebration in Muscat", caption: "Onam celebration performance for the Malayali community in Muscat.", category: "Live performance", collection: "Stage", orientation: "landscape", focalPoint: "50% 48%" },
  { src: "/portfolio/09-close-live-vocal.webp", alt: "Close view of Arun Guinness singing into a microphone in a red shirt", caption: "Voice craft in focus during a live programme.", category: "Live performance", collection: "Stage", orientation: "portrait", focalPoint: "63% 43%" },
  { src: "/portfolio/03-stage-in-yellow.webp", alt: "Arun Guinness speaking into a microphone under purple stage lights", caption: "Connecting with the room between songs under the stage lights.", category: "Live performance", collection: "Stage", orientation: "portrait", focalPoint: "50% 42%" },
  { src: "/portfolio/02-dhun-recognition.webp", alt: "Arun Guinness presenting a certificate during the DHUN 2024 prize distribution", caption: "A prize-distribution moment at DHUN 2024.", category: "Recognition", collection: "Occasions", orientation: "landscape", focalPoint: "50% 48%" },
  { src: "/portfolio/14-school-recognition.webp", alt: "Arun Guinness receiving a gift and handshake at a school programme", caption: "Recognition following a school programme and performance.", category: "Recognition", collection: "Campus", orientation: "landscape", focalPoint: "52% 48%" },
  { src: "/portfolio/07-school-honour.webp", alt: "Arun Guinness receiving a trophy at St Juliana's Public School", caption: "An honour shared at St. Juliana's Public School.", category: "Recognition", collection: "Campus", orientation: "landscape", focalPoint: "50% 48%" },
  { src: "/portfolio/05-school-inauguration.webp", alt: "Arun Guinness joining a ceremonial lamp lighting at a school annual day", caption: "Joining the ceremonial opening of a school annual-day celebration.", category: "Community event", collection: "Occasions", orientation: "landscape", focalPoint: "50% 50%" },
  { src: "/portfolio/08-onam-inauguration.webp", alt: "Arun Guinness lighting a ceremonial lamp at an Onam celebration", caption: "Opening an Onam gathering with the traditional lamp-lighting ceremony.", category: "Community event", collection: "Occasions", orientation: "landscape", focalPoint: "50% 48%" },
  { src: "/portfolio/11-blue-blazer-stage.webp", alt: "Arun Guinness smiling with a microphone while wearing a blue blazer", caption: "A stage portrait between performance moments.", category: "Portrait", collection: "Portraits", orientation: "landscape", focalPoint: "50% 42%" },
  { src: "/portfolio/06-blue-kurta-portrait.webp", alt: "Portrait of Arun Guinness smiling in a blue kurta at an outdoor event", caption: "Between programmes, ready for the next gathering.", category: "Portrait", collection: "Portraits", orientation: "portrait", focalPoint: "50% 35%" },
  { src: "/portfolio/10-performer-moment.webp", alt: "Arun Guinness taking a selfie with two fellow performers backstage", caption: "A relaxed stage-side moment with fellow performers.", category: "Portrait", collection: "Portraits", orientation: "portrait", focalPoint: "50% 42%" },
  { src: "/portfolio/15-campus-inauguration.webp", alt: "Arun Guinness joining guests for a ceremonial lamp lighting on a school stage", caption: "Joining the opening ceremony before a school celebration.", category: "Community event", collection: "Occasions", orientation: "landscape", sourcePage: 38 },
  { src: "/portfolio/16-crowd-celebration.webp", alt: "A large audience celebrating with Arun Guinness and guests in front of a school stage", caption: "The energy of a full audience, shared from the stage.", category: "Community event", collection: "Campus", orientation: "landscape", sourcePage: 43 },
  { src: "/portfolio/17-among-students.webp", alt: "Arun Guinness singing as he walks through a hall of students", caption: "Bringing the performance into the middle of the audience.", category: "Community event", collection: "Campus", orientation: "landscape", focalPoint: "59% 50%", sourcePage: 50 },
  { src: "/portfolio/18-night-stage.webp", alt: "Arun Guinness singing to an outdoor audience at an evening event", caption: "An open-air performance after the lights come on.", category: "Live performance", collection: "Stage", orientation: "landscape", focalPoint: "44% 50%", sourcePage: 74 },
  { src: "/portfolio/19-school-honour.webp", alt: "Arun Guinness receiving an award from a guest on a school stage", caption: "A moment of recognition at a school event.", category: "Recognition", collection: "Campus", orientation: "landscape", sourcePage: 89 },
  { src: "/portfolio/20-school-crowd-performance.webp", alt: "Arun Guinness singing among smiling schoolchildren and guests", caption: "The audience becomes part of the performance.", category: "Community event", collection: "Campus", orientation: "landscape", focalPoint: "52% 52%", sourcePage: 94 },
  { src: "/portfolio/21-campus-microphone.webp", alt: "Arun Guinness speaking and singing at a school event microphone", caption: "A voice-led moment at a school programme.", category: "Live performance", collection: "Campus", orientation: "landscape", sourcePage: 97 },
  { src: "/portfolio/22-student-voice-moment.webp", alt: "Arun Guinness singing in the middle of a cheering student audience", caption: "A familiar song carried through a hall of students.", category: "Community event", collection: "Campus", orientation: "landscape", sourcePage: 99 },
  { src: "/portfolio/23-school-auditorium.webp", alt: "Arun Guinness facing a full school auditorium from the stage", caption: "A full school auditorium seen from the performer's side of the stage.", category: "Live performance", collection: "Campus", orientation: "landscape", sourcePage: 100 },
  { src: "/portfolio/24-guest-appreciation.webp", alt: "Arun Guinness receiving a commemorative gift from a guest at an event", caption: "A guest appearance marked with a presentation.", category: "Recognition", collection: "Occasions", orientation: "landscape", sourcePage: 102 },
  { src: "/portfolio/25-institutional-recognition.webp", alt: "Arun Guinness receiving a commemorative plaque from a school representative", caption: "An honour shared at an institutional event.", category: "Recognition", collection: "Occasions", orientation: "landscape", sourcePage: 112 },
] as const;
